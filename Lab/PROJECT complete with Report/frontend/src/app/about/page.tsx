    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="w-full bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-6">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">About HY Academy</h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-4 leading-relaxed">
                HY Academy&apos;s purpose is to democratize education. We aim to empower individuals with the skills they need to compete in the job market and achieve their career goals.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="bg-white rounded-lg p-8 md:p-12 shadow-md">
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              HY Academy was founded in 2012 by Daphne Koller and Andrew Ng, computer scientists at Stanford University who wanted to make world-class education accessible to everyone. What started as a vision to democratize higher education has grown into a global learning platform.
            </p>
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              Today, HY Academy works with more than 200 leading universities and companies to offer courses, specializations, and degrees that are accessible and affordable. Our learners come from every corner of the world, united by a desire to learn, grow, and achieve their goals.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
